...
exports.getActor = (req, res, next) => {
    ...
    User.findById(req.user.id).exec(function(err, user) {
        Actor.findOne({ username: req.params.userId }, (err, act) => {
            ...
            user.logPage(Date.now(), req.params.userId); // To do: check if this works.
            ...
            Script.find({ actor: act.id })
                ...
                .exec(function(err, script_feed) {
                    ...
                    res.render('actor', { script: script_feed, actor: act, blocked: isBlocked, reported: isReported });
                });
        });
    });
};
...
/**
 * POST /user
 * Update block or report actor list.
 */
